 ...
 */
public class DateCalculateProblem {
    ...
    private static void wrong1() {
        ...
        Date today = new Date();
        Date nextMonth = new Date(today.getTime() + 30 * 1000 * 60 * 60 * 24); // 数据溢出
        System.out.println(today);
        System.out.println(nextMonth);
    }

    private static void wrong1fix() {
        System.out.println(30 * 1000 * 60 * 60 * 24 + " " + (30L * 1000 * 60 * 60 * 24 > Integer.MAX_VALUE)); // 不符合预期结果
    ...
    private static void test() {
        ...
        // 利用 Period.between 获取的是两个日期的差值 年-月-日
